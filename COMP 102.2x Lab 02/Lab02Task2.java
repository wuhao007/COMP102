...
public class Lab02Task2
{
    ...
    public GameRecord[] loadGameRecord(java.io.Reader reader) {
        ...
        while (scanner.hasNextLine()) {
            ...
            records[i++] = new GameRecord(line[0], Integer.parseInt(line[1]), Integer.parseInt(line[2]));
        }
        return java.util.Arrays.copyOfRange(records, 0, i); // this line should be modified/removed after finishing the implementation of this method.
    }
